    ...
    <footer className="hidden lg:block h-20 w-full border-t-2 border-slate-200 p-2">
      <div className="max-w-screen-lg mx-auto flex items-center justify-evenly h-full">
        <Button size="lg" variant="ghost" className="w-full">
          <Image src="/ng.svg" alt="Nigeria" height={32} width={40} className="mr-4 rounded-md" />
            Youruba, Hausa, Igbo
        </Button>
        ...
        <Button size="lg" variant="ghost" className="w-full">
          <Image src="/sa.svg" alt="Arabic" height={32} width={40} className="mr-4 rounded-md" />
            Arabic
        </Button>
        ...
        <Button size="lg" variant="ghost" className="w-full">
          <Image src="/de.svg" alt="Garman" height={32} width={40} className="mr-4 rounded-md" />
            Garmany
        </Button>
      </div>
    </footer>
